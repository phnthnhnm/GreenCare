...
namespace api.Data.Migrations
{
    ...
    [Migration("20240626094702_AddPlantCareLog")]
    partial class AddPlantCareLog
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "ae4352aa-bb87-4bf8-9b51-266e1825d0be",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "07674c2c-ee72-4789-a8a1-4df8b27b3cd0",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
                        {
                            Id = "48dd1f1f-e09e-467a-bb5c-4ec5b05cfa7e",
                            Name = "Expert",
            ...
            modelBuilder.Entity("api.Models.PlantCareLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("api.Models.PlantCareLog", b =>
                {
                    b.HasOne("api.Models.Appointment", "Appointment")
                        .WithOne("PlantCareLog")
                        .HasForeignKey("api.Models.PlantCareLog", "AppointmentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
